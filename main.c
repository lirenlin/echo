...
#define WIFI_PASSWORD            ("321qazxcdews")
#define LED_NUM	                 5
hal_gpio_pin_t led_pins[] = {HAL_GPIO_31, HAL_GPIO_35, HAL_GPIO_34,
    HAL_GPIO_33, HAL_GPIO_6};
...
void gpio_configure ()
{
     ...
     * GPIO6  --> D15
     */
    uint8_t gpio_function[] = {HAL_GPIO_31_GPIO31, HAL_GPIO_35_GPIO35,
        HAL_GPIO_34_GPIO34, HAL_GPIO_33_GPIO33, HAL_GPIO_6_GPIO6};
    ...
    for (unsigned short i = 0; i < LED_NUM; ++i)
    {
        ...
        ret_pinmux_status = hal_pinmux_set_function(pin, gpio_function[i]);
